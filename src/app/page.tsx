  ...
  return (
    <>
      <a
        ...
        className="flex w-full items-center justify-center gap-2.5 border-b border-violet-500/30 bg-violet-950/80 px-4 py-2.5 text-sm font-semibold text-violet-200 transition hover:bg-violet-900/80 hover:text-white"
      >
